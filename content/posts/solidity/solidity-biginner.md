...
プログラミングを始めたばかりの人は、プログラミングそのものの難しさではなく、プログラムを実行する環境に問題が起きてしまうことが原因で挫折してしまう人がたくさんいます。

始めたばかりの頃は、エラーが起きたときに、プログラムのコードが間違っているのか、環境構築が間違っているのかは判断ができません。

プログラミング言語を覚えたいのに、インストールや実行中にエラーが起きてしまい、時間だけが過ぎてしまいます。

だから、一番はじめは環境構築が不要な学習方法が適していると筆者は考えています。
